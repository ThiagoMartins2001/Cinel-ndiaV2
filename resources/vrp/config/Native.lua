...
function CheckPolice()
	return LocalPlayer["state"]["PoliciaMilitar"]
end

-- CHECKCORE
-----------------------------------------------------------------------------------------------------------------------------------------
function CheckCore()
	return LocalPlayer["state"]["Core"]
end

-- CHECKPRF
-----------------------------------------------------------------------------------------------------------------------------------------
function CheckPRF()
	return LocalPlayer["state"]["PRF"]
end

-- CHECKPCIVIL
-----------------------------------------------------------------------------------------------------------------------------------------
function CheckPCivil()
	return LocalPlayer["state"]["PCivil"]
end
-----------------------------------------------------------------------------------------------------------------------------------------
-- CHECKPARAMEDIC
-----------------------------------------------------------------------------------------------------------------------------------------
function CheckParamedic()
	return LocalPlayer["state"]["Paramedic"]
end