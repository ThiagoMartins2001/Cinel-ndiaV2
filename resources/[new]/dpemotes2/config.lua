Config = {
    ...
    MenuImage = "https://media.discordapp.net/attachments/1303330139316420658/1357054672212590622/LOGO_Absolut_RP_2000x2000_Extra_-_Variacao_1_-_by_Design_Ideal.png", ----[Custom banner imgur URLs go here ]---
...
Config.Languages = {
    ['en'] = { -- English 🇬🇧
        ['whitecustom'] = '~p~Sublime Emotes 3.0~w~',
        ['whitecustom2do'] = '~p~Sublime Emotes 4.0~w~',
        ['emotes'] = 'Emotes 🎬',
