-- --------------------------------------------------------
-- Servidor:                     127.0.0.1
-- Versão do servidor:           11.5.1-MariaDB - mariadb.org binary distribution
...
-- Copiando estrutura do banco de dados para banguv23
CREATE DATABASE IF NOT EXISTS `absolut` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
USE `absolut`;

-- Copiando estrutura para tabela banguv23.skins
...
-- Copiando dados para a tabela banguv23.skins: ~62 rows (aproximadamente)
...
-- Copiando estrutura para tabela banguv23.skins_users
...
-- Copiando dados para a tabela banguv23.skins_users: ~0 rows (aproximadamente)
