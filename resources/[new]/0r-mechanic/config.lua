...
Config.Locations = {
    ["Bennys Workshop"] = {
        ...
        job = "Mechanic",
        coords = {
            vector3(909.13,-2128.06,30.55)
        },
        showBlip = false,
        blipSprite = 0.0,
        blipColor = 2,
        blipCoords = vector3(-236.82,-1338.0,30.63),
    },
    ["Bennys Workshop2"] = {
        illegalMechanic = true,
        job = "Bennys",
        coords = {
            vector3(-235.66,-1327.23,30.63)
        },
        showBlip = false,
        blipSprite = 272.13,
        blipColor = 2,
        blipCoords = vector3(-235.66,-1327.23,30.63),
    },
    ["Bennys Workshop3"] = {
        illegalMechanic = true,
        job = "Bennys",
        coords = {
            vector3(-227.06,-1314.32,18.18)
        },
        showBlip = false,
        blipSprite = 85.04,
        blipColor = 2,
        blipCoords = vector3(-227.06,-1314.32,18.18),
    },
    ["Carzone"] = {
        illegalMechanic = true,
        job = "Carzone",
        coords = {
            vector3(145.01,-3030.29,7.04)
        },
        showBlip = false,
        blipSprite = 85.04,
        blipColor = 63,
        blipCoords = vector3(145.01,-3030.29,7.04),
    },
    ["Carzone2"] = {
        illegalMechanic = true,
        job = "Carzone",
        coords = {
            vector3(135.92,-3030.43,7.04)
        },
        showBlip = false,
        blipSprite = 85.04,
        blipColor = 63,
        blipCoords = vector3(135.92,-3030.43,7.04),
    },
}
