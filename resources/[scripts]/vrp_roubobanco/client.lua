                ...
                if allowed then
					...
					local police = RBserver.copsonline()
                        ...
                        if police >= v.Cops then
							...
							TriggerEvent("Notify",'vermelho',"Não há policiais suficientes online!", 5000)
                        end
                    end
                end
                Wait(10)
                ...
                if v.Money.Amount > 0 then
                    ...
                    if IsControlPressed(0, 38) then
                        ...
                        if police >= v.Cops then
							...
							TriggerEvent("Notify","vermelho","Não há policiais suficientes em serviço.", 5000)
                        end
                    end
                end
            end
                            ...
                            if allowed then
                                ...
                                if IsControlPressed(0, 38) then
                                    ...
                                    if j == 1 or j == 2 then
                                        ...
                                        TriggerEvent("Notify","vermelho","Você não possui uma C4!", 5000)  
                                    end
                                    else
                                        ...
                                        TriggerEvent("Notify","vermelho","Você não possui uma serra!", 5000)
                                    end
                                    end
                                    else
										TriggerEvent("Notify","vermelho","Não há policiais suficientes online!", 5000)
                        ...
                        if GetDistanceBetweenCoords(coords, s.Coords, true) <= 1.0 and not Config.BankRobbery[i].Doors[#Config.BankRobbery[i].Doors].Frozen then
                            ...
                            if IsControlPressed(0, 38) then
                                ...
                                if RBserver.getitem("furadeira") then
                                   ...
                                   TriggerEvent("Notify","vermelho","Você não possui uma furadeira!", 5000)
                                end    
                                else
									TriggerEvent("Notify","vermelho","Não há policiais suficientes online!", 5000)
                                end
