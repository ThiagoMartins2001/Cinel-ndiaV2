...
CreateThread(function()
	...
	-- AddBoxZone("CallMcdonalds",vec3(-1187.86,-904.92,13.73),0.25,0.25,{
	-- 	name = "CallMcdonalds",
	-- 	heading = 3374176,
	-- 	minZ = 13.50,
	-- 	maxZ = 14.00
	...
	AddBoxZone("WorkIfood",vec3(-70.86,16.62,72.39), 1.5, 1.5,{
        name = "WorkIfood",
        heading = 65.2,
    },{
        Distance = 1.0,
	...
	AddCircleZone("tabletVehicles03",vec3(-56.24,-1098.59,26.42),1.5,{
	...
	AddCircleZone("tabletVehicles04",vec3(-51.59,-1094.98,27.26),1.5,{
					...
					elseif IsPedAPlayer(Entity) then
						if #(Coords - entCoords) <= 1.0 then
							...
							elseif LocalPlayer["state"]["Paramedic"] then
								...
								if IsEntityPlayingAnim(Entity,"random@mugging3","handsup_standing_base",3) or IsEntityPlayingAnim(Entity,"dead","dead_a",3) then
