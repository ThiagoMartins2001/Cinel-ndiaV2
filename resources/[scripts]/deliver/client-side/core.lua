...
-----------------------------------------------------------------------------------------------------------------------------------------
local List = {
	--["Mcdonalds"] = { -1191.32,-900.39,13.99,1.0,1.0,"Trabalhar",false },
	...
	["Lumberman"] = { 2411.64,5046.04,46.02,0.5,1.0,"Trabalhar",false },
	["Transporter"] = { 11.28,-661.43,33.45,280.63,1.0,"Trabalhar",true }
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- THREADSTART
-----------------------------------------------------------------------------------------------------------------------------------------
...
local Cds = {
	...
	--	{ 315.09,-593.65,43.29 },
		...
		--{ 129.55,-1291.88,29.27 },
		--{ 130.13,-1292.69,29.27 },
		{ 33.3,-1347.94,29.49 },
		{ 24.48,-945.95,29.35 },
		{ 5.24,-919.83,29.55 },
		{ 112.58,-819.4,31.34 },
