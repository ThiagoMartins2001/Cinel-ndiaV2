...
-----------------------------------------------------------------------------------------------------------------------------------------
local Colors = {
	["PoliciaMilitar"] = 63,  -- Azul (cor original da Police)
	["Core"] = 1,             -- Vermelho
	["PRF"] = 5,              -- Amarelo
	["PCivil"] = 2,           -- Verde
	["Paramedic"] = 6,        -- Laranja
...
CreateThread(function()
	while true do
		if LocalPlayer["state"]["Active"] then
			if LocalPlayer["state"]["PoliciaMilitar"] or LocalPlayer["state"]["Core"] or LocalPlayer["state"]["PRF"] or LocalPlayer["state"]["PCivil"] or LocalPlayer["state"]["Paramedic"] then
