...
GlobalState["Doors"] = {
	...
	-- Mcdonalds
	[134] = { Coords = vec3(-1181.35,-886.29,13.88), Hash = -1890974902, Lock = true, Distance = 1.5, Perm = "Mcdonalds"},
	[135] = { Coords = vec3(-1181.35,-886.29,13.88), Hash = 1143532813, Lock = true, Distance = 1.5, Perm = "Mcdonalds"},
	[136] = { Coords = vec3(-1197.92,-904.58,13.88), Hash = 1465287574, Lock = true, Distance = 1.5, Perm = "Mcdonalds"},

	[137] = { Coords = vec3(1131.08,-474.3,66.71), Hash = -2023754432, Lock = true, Distance = 1.5, Perm = "Ifrut"},
	...
	[176] = { Coords = vec3(-1887.9,2051.39,141.32), Hash = 1077118233, Lock = true, Distance = 1.5, Perm = "Favela05", Other = 177},
	[177] = { Coords = vec3(-1890.22,2052.24,141.32), Hash = 1077118233, Lock = true, Distance = 1.5, Perm = "Favela05", Other = 176},
	[178] = { Coords = vec3(-1887.53,2051.24,141.32), Hash = 1077118233, Lock = true, Distance = 1.5, Perm = "Favela05", Other = 179},
	[179] = { Coords = vec3(-1885.21,2050.38,141.31), Hash = 1077118233, Lock = true, Distance = 1.5, Perm = "Favela05", Other = 178},
	[180] = { Coords = vec3(-1884.92,2073.47,141.31), Hash = 1077118233, Lock = true, Distance = 1.5, Perm = "Favela05", Other = 181},
	[181] = { Coords = vec3(-1887.24,2074.31,141.32), Hash = 1077118233, Lock = true, Distance = 1.5, Perm = "Favela05", Other = 180},
	[182] = { Coords = vec3(-1875.61,2070.07,141.32), Hash = 1077118233, Lock = true, Distance = 1.5, Perm = "Favela05", Other = 183},
	[183] = { Coords = vec3(-1873.29,2069.22,141.31), Hash = 1077118233, Lock = true, Distance = 1.5, Perm = "Favela05", Other = 182},
	[184] = { Coords = vec3(-1894.72,2075.97,141.32), Hash = 1077118233, Lock = true, Distance = 1.5, Perm = "Favela05", Other = 185},
	[185] = { Coords = vec3(-1892.83,2074.39,141.31), Hash = 1077118233, Lock = true, Distance = 1.5, Perm = "Favela05", Other = 184},
	[186] = { Coords = vec3(-1898.51,2082.86,140.92), Hash = 1843224684, Lock = true, Distance = 1.5, Perm = "Favela05", Other = 187},
	[187] = { Coords = vec3(-1900.4,2084.45,140.92), Hash = 1843224684, Lock = true, Distance = 1.5, Perm = "Favela05", Other = 186},
	[188] = { Coords = vec3(-1900.99,2084.95,140.92), Hash = 1843224684, Lock = true, Distance = 1.5, Perm = "Favela05", Other = 189},
	[189] = { Coords = vec3(-1902.88,2086.55,140.92), Hash = 1843224684, Lock = true, Distance = 1.5, Perm = "Favela05", Other = 188},
	[190] = { Coords = vec3(-1905.99,2085.63,140.92), Hash = 1843224684, Lock = true, Distance = 1.5, Perm = "Favela05", Other = 191},
	[191] = { Coords = vec3(-1907.59,2083.75,140.92), Hash = 1843224684, Lock = true, Distance = 1.5, Perm = "Favela05", Other = 190},
	[192] = { Coords = vec3(-1910.2,2080.68,140.92), Hash = 1843224684, Lock = true, Distance = 1.5, Perm = "Favela05", Other = 193},
	[193] = { Coords = vec3(-1911.81,2078.8,140.92), Hash = 1843224684, Lock = true, Distance = 1.5, Perm = "Favela05", Other = 192},
	[194] = { Coords = vec3(-1912.1,2075.57,140.92), Hash = 1843224684, Lock = true, Distance = 1.5, Perm = "Favela05", Other = 195},
	[195] = { Coords = vec3(-1910.2,2073.97,140.92), Hash = 1843224684, Lock = true, Distance = 1.5, Perm = "Favela05", Other = 194},
	[196] = { Coords = vec3(-1909.62,2073.48,140.92), Hash = 1843224684, Lock = true, Distance = 1.5, Perm = "Favela05", Other = 197},
	[197] = { Coords = vec3(-1907.73,2071.88,140.92), Hash = 1843224684, Lock = true, Distance = 1.5, Perm = "Favela05", Other = 186},
	[198] = { Coords = vec3(-1861.68,2054.12,141.36), Hash = 1077118233, Lock = true, Distance = 1.5, Perm = "Favela05", Other = 199},
	[199] = { Coords = vec3(-1859.21,2054.12,141.36), Hash = 1077118233, Lock = true, Distance = 1.5, Perm = "Favela05", Other = 198},
	[200] = { Coords = vec3(-1864.19,2059.9,141.15), Hash = -1141522158, Lock = true, Distance = 1.5, Perm = "Favela05", Other = 201},
	[201] = { Coords = vec3(-1864.21,2061.27,141.15), Hash = 988364535, Lock = true, Distance = 1.5, Perm = "Favela05", Other = 200},
...
--- POLICIA SUL
	...
	[269] = { Coords = vec3(-582.67,228.4,79.43), Hash = -612979079, Lock = true, Distance = 2.5, Perm = "Ifrut", Other = 268 },
	...
	if Passport then
		if GlobalState["Doors"][Number]["Perm"] ~= nil then
			if vRP.HasService(Passport,GlobalState["Doors"][Number]["Perm"]) or vRP.hasPermission(Passport,'Admin',2) then
				if vRP.hasPermission(Passport,'Admin',2) then
